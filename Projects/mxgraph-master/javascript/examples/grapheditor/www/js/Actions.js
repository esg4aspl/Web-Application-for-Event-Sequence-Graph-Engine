...
//	this.addAction('export', function() {ui.saveFile(false); }, null, null, Editor.ctrlKey + '+S').isEnabled = isGraphEnabled;
	...
	this.addAction('save',function() {ui.sendJSON(); });
	this.addAction('saveAs',function(){ ui.saveFile(true) });
	this.addAction('generate',function(){
		ui.showDialog(new TestCaseDialog(ui).container, 300, 230, true, true);
	});
	this.addAction('history',function(){
	//	ui.showDialog(new TestCaseDialog(ui).container, 300, 230, true, true);
	});

...
Format.prototype.refresh = function()
{
	...
	if(ss.style.shape == 'squareEllipse'){
		div.style.whiteSpace = 'wrap';
		label.style.padding = '5px 37px 0px 0px';
	}
	else{
	...
	else
	{
	    ...
	    if(ss.style.shape == 'squareEllipse'){
	    	...
	    	mxUtils.write(label4,mxResources.get('decisiontable'));
			div.appendChild(label4);
			
	    	var decisionTablePanel = div.cloneNode(false);
			decisionTablePanel.style.display = 'none';
	        
	        this.panels.push(new DecisionTableFormatPanel(this, ui, decisionTablePanel));
			this.container.appendChild(decisionTablePanel);
			addClickHandler(label4, decisionTablePanel, idx++);
	    }
...
DecisionTableFormatPanel = function(format, editorUi, container){
	BaseFormatPanel.call(this, format, editorUi, container);
	this.init();
};

mxUtils.extend(DecisionTableFormatPanel, BaseFormatPanel);

DecisionTableFormatPanel.prototype.init = function(){
   
	this.getTableInfo(this.container);
	
    

};

DecisionTableFormatPanel.prototype.getTableInfo = function(container){
	
	 var actionTitle = this.createTitle(mxResources.get('actionTitle'));
	 actionTitle.style.marginTop = '10px';
	 actionTitle.style.marginBottom = '6px';
	 container.appendChild(actionTitle);
	
	 var actionTextarea = document.createElement("input");
	 actionTextarea.setAttribute('type', 'text');
	 actionTextarea.setAttribute('placeholder', 'Number of Actions');
	 actionTextarea.style.width = '150px';
	 actionTextarea.style.position ='absolute';
	 actionTextarea.style.marginTop = '1px';
	 actionTextarea.style.marginBottom = '6px';
	 actionTextarea.style.borderRadius = '4px';
	 container.appendChild(actionTextarea);
	
	 var conditionTextarea = document.createElement("input");
	 conditionTextarea.setAttribute('type','text');
	 conditionTextarea.setAttribute('placeholder','Number of Conditions');
	 conditionTextarea.style.width = '150px';
	 conditionTextarea.style.position = 'absolute';
	 conditionTextarea.style.marginTop = '30px';
	 conditionTextarea.style.marginBottom = '6px';
	 conditionTextarea.style.borderRadius = '4px';
	 container.appendChild(conditionTextarea);
	 
	 var ruleTextarea = document.createElement("input");
	 ruleTextarea.setAttribute('type', 'text');
	 ruleTextarea.setAttribute('placeholder', 'Number of Rules');
	 ruleTextarea.style.width = '150px';
	 ruleTextarea.style.position ='absolute';
	 ruleTextarea.style.marginTop = '60px';
	 ruleTextarea.style.marginBottom = '6px';
	 ruleTextarea.style.borderRadius = '4px';
	 container.appendChild(ruleTextarea);
	 
	
	 
	 var tableButton = mxUtils.button(mxResources.get('table'), function(evt)
				{
		                 actionTitle.style.display= 'none';
		                 actionTextarea.style.display = 'none';
		                 conditionTextarea.style.display = 'none';
		                 ruleTextarea.style.display = 'none';
		            	
		                
		                //creating decision table for condition
		                 var conditionDecisionTable = document.createElement('table');
		                 conditionDecisionTable.setAttribute('id','decision')
		                 conditionDecisionTable.style.borderCollapse = 'collapse';
		                 conditionDecisionTable.style.marginTop = '10px';
		                 var conditionTableBody = document.createElement('tbody');
		                 var conditionColumnCount =  parseInt(ruleTextarea.value)+1;
		                 var conditionRowCount    =parseInt(conditionTextarea.value)+1;
		                 
		                 for(var r = 0; r < conditionRowCount; r++){
		                	 var conditionRow = document.createElement("tr");
		                	 for (var c = 0; c < conditionColumnCount; c++) {
		                		  var conditionCell = document.createElement("td");
		                		  conditionCell.style.borderCollapse = 'seperate';
		                		  conditionCell.style.border = '1px solid black';
		                		  conditionCell.style.width  = '60px';
		                		  conditionCell.style.height = '20px';
		                	  
		                	      //first row no textarea
		                		  if(r != 0){
		                			 // var conditionCellText = document.createElement("textarea");
		                		      var conditionCellText = document.createElement("input");
		                		      conditionCellText.setAttribute('type', 'text');
		                			  conditionCellText.setAttribute('cols','1');
		                			  conditionCellText.setAttribute('rows',"100");
		                			  conditionCellText.style.textAlign = 'left';
		                			  conditionCellText.style.fontSize = 'small';
		                			  conditionCellText.style.width = '%100';
		                			  conditionCellText.style.height = '20px';
		                		//	  conditionCellText.cols = "20";
		                			//  conditionCellText.rows = "2";
		                			  conditionCellText.style.border = 'none';
			                	      conditionCell.appendChild(conditionCellText);
		                		 }
		                		 
		                		 else{
		                			  if(r == 0 && c == 0){
		                				  var nonEditableConditionCellText = document.createTextNode("Conditions");
		                				  conditionCell.appendChild(nonEditableConditionCellText);
		                				  
		                			  }
		                			  else{
		                				  var ruleCellText = document.createTextNode("R"+c);
		                				  conditionCell.appendChild(ruleCellText);
		                			  }
		                		  }
		                 ...
		                 //creating decision table for action
		                 var decisionTableAction = document.createElement('table');
		                 decisionTableAction.setAttribute('id','actionDecision');
		                 decisionTableAction.style.borderCollapse = 'collapse';
		                 decisionTableAction.style.marginTop = '10px';
		                 //action table body 
		                 var actionTableBody = document.createElement('tbody');
		                 var actionColumnCount =  parseInt(ruleTextarea.value)+1;
		                 var actionRowCount    = parseInt(actionTextarea.value)+1;
		                 
		                 for(var r = 0; r < actionRowCount; r++){
		                	 var actionRow = document.createElement("tr");
		                	 for(var c =0; c < actionColumnCount; c++){
		                		 var actionCell = document.createElement("td");
		                		 actionCell.style.borderCollapse = 'seperate';
		                		 actionCell.style.border = '1px solid black';
		                		 actionCell.style.width = '60px';
		                		 actionCell.style.height= '20px';
		                		 
		                		 //first action row no textarea
		                		 if(r != 0){
		                			  var actionCellText = document.createElement("input");
		                			  actionCellText.setAttribute('type','text');
		                			  actionCellText.style.textAlign = 'left';
		                			  actionCellText.style.fontSize = 'small';
		                			  actionCellText.style.width = '%100';
		                			  actionCellText.style.height = '20px';
		                			  actionCellText.style.border = 'none';
		                			  actionCell.appendChild(actionCellText);
		                			  }
		                		 else{
		                			  if(r == 0 && c == 0){
		                				  var nonEditableActionCellText = document.createTextNode("Actions");
		                				  actionCell.appendChild(nonEditableActionCellText);
		                				  
		                			  }
		                			  else{
		                				  var ruleCellText = document.createTextNode("R"+c);
		                				  actionCell.appendChild(ruleCellText);
		                			  }
		                 ...
		                 //hiding info textarea
		                 if(actionTextarea.style.display == 'none' || conditionTextarea.style.display == 'none' 
		                	 || ruleTextarea.style.display == 'none'){
		                	 
		                	 var incrementConditionButton = mxUtils.button(mxResources.get('conditionInc'), function(evt){
		                		 var addedConditionRow = document.createElement("tr");
		                		 var columnsCount = document.getElementById("decision").rows[0].cells.length;
			                		for (var c = 0; c < columnsCount; c++) {
			                			var addedConditionCell = document.createElement("td");
			                			addedConditionCell.style.borderCollapse = 'seperate';
			                			addedConditionCell.style.border = '1px solid black';
			                			addedConditionCell.style.width  = '60px';
			                			addedConditionCell.style.height = '20px';
				                		var addedConditionCellText = document.createElement("input");
				                		
				                		addedConditionCellText.setAttribute('type', 'text');
				                		
				                		addedConditionCellText.style.textAlign = 'left';
				                		addedConditionCellText.style.fontSize = 'small';
				                		addedConditionCellText.style.width = '%100';
				                		addedConditionCellText.style.height = '20px';
				                		addedConditionCellText.style.border = 'none';
				                		addedConditionCell.appendChild(addedConditionCellText);
				                		addedConditionRow.appendChild(addedConditionCell);
			                		}
			                		 
			                		conditionTableBody.appendChild(addedConditionRow);
		                
		                	 })
		                	
		                	
		                	 incrementConditionButton.style.width = '100px';
		                	 incrementConditionButton.style.position ='absolute';
		                	 
		                	 incrementConditionButton.style.top = '100px';
		                	 incrementConditionButton.style.left = '120px';
		                	 incrementConditionButton.style.marginTop = '20px';
		                	 incrementConditionButton.style.borderRadius = '4px';
		                	 incrementConditionButton.style.backgroundColor ='white';
		                	 container.appendChild(incrementConditionButton);
		                	 
		                	 var incrementActionButton = mxUtils.button(mxResources.get('actionInc'),function(evt){
		                		 var addedActionRow = document.createElement("tr");
		                		 var actionColumnsCount = document.getElementById("actionDecision").rows[0].cells.length;
			                		for (var c = 0; c < actionColumnsCount; c++) {
			                			var addedActionCell = document.createElement("td");
			                			addedActionCell.style.borderCollapse = 'seperate';
			                			addedActionCell.style.border = '1px solid black';
			                			addedActionCell.style.width  = '60px';
			                			addedActionCell.style.height = '20px';
				                		var addedActionCellText = document.createElement("input");
				                		addedActionCellText.setAttribute('type', 'text');
				                		addedActionCellText.style.textAlign = 'left';
				                		addedActionCellText.style.fontSize = 'small';
				                		addedActionCellText.style.width = '%100';
				                		addedActionCellText.style.height = '20px';
				                		addedActionCellText.style.border = 'none';
				                		addedActionCell.appendChild(addedActionCellText);
				                		addedActionRow.appendChild(addedActionCell);
			                		}
			                		 
			                		actionTableBody.appendChild(addedActionRow);
		                	 })
		                	 incrementActionButton.style.width = '100px';
		                	 incrementActionButton.style.position ='absolute';
		                	 incrementActionButton.style.top = '135px';
		                	 incrementActionButton.style.left = '120px';
		                	 incrementActionButton.style.marginTop = '10px';
		                	 incrementActionButton.style.borderRadius = '4px';
		                	 incrementActionButton.style.backgroundColor ='white';
		                	 container.appendChild(incrementActionButton);
		                	 
		                   	 
		                   	
		                	 var incrementRuleButton = mxUtils.button(mxResources.get('ruleInc'),function(evt){
		                		 var rowsCount = document.getElementById("decision").rows.length;
		                		 var allRows = document.getElementById("decision").rows;
		                		 var columns =  allRows[0].cells.length;
		                		 for (var r = 0; r < rowsCount ; r++){
		                			 var addedRuleCell = document.createElement("td");
		                			 var addedRuleCellText = document.createElement("input");
		                			 addedRuleCellText.setAttribute('type', 'text');
		                			 addedRuleCell.style.borderCollapse = 'seperate';
		                			 addedRuleCell.style.border = '1px solid black';
		                			 addedRuleCell.style.width  = '60px';
		                			 addedRuleCell.style.height = '20px';
		                			
		                			 if ( r != 0){
		                				
				                		 addedRuleCellText.style.textAlign = 'left';
				                		 addedRuleCellText.style.fontSize = 'small';
				                		 addedRuleCellText.style.width = '%100';
				                		 addedRuleCellText.style.height = '20px';
				                		 addedRuleCellText.style.border = 'none';
				                		 addedRuleCell.appendChild(addedRuleCellText);
			                			}
		                			 else{
		                				 var ruleCellText = document.createTextNode("R"+(columns));
		                				 addedRuleCell.appendChild(ruleCellText);
		                			 }
		                			 allRows[r].appendChild(addedRuleCell);
		                		 }
		                		 
		                		 var actionRowsCount = document.getElementById("actionDecision").rows.length;
		                		 var actionAllRows = document.getElementById("actionDecision").rows;
		                		 var actioncolumns =  actionAllRows[0].cells.length;
		                		 //for action table
		                		 for (var r = 0; r < actionRowsCount ; r++){
		                			 var addedActionRuleCell = document.createElement("td");
		                			 var addedActionRuleCellText = document.createElement("input");
		                			 addedActionRuleCellText.setAttribute('type', 'text');
		                			 addedActionRuleCell.style.borderCollapse = 'seperate';
		                			 addedActionRuleCell.style.border = '1px solid black';
		                			 addedActionRuleCell.style.width  = '60px';
		                			 addedActionRuleCell.style.height = '20px';
		                			
		                			 if ( r != 0){
		                				
		                				 addedActionRuleCellText.style.textAlign = 'left';
		                				 addedActionRuleCellText.style.fontSize = 'small';
		                				 addedActionRuleCellText.style.width = '%100';
		                				 addedActionRuleCellText.style.height = '20px';
		                				 addedActionRuleCellText.style.border = 'none';
				                		 addedActionRuleCell.appendChild(addedActionRuleCellText);
			                			}
		                			 else{
		                				 var ruleCellText = document.createTextNode("R"+(columns));
		                				 addedActionRuleCell.appendChild(ruleCellText);
		                			 }
		                			 actionAllRows[r].appendChild(addedActionRuleCell);
		                		 }
		                	   
		                		
		                		 
		                	 })
		                	 incrementRuleButton.style.width = '100px';
		                	 incrementRuleButton.style.position ='absolute';
		                	 incrementRuleButton.style.top = '170px';
		                	 incrementRuleButton.style.left = '120px';
		                	 incrementRuleButton.style.borderRadius = '4px';
		                	 incrementRuleButton.style.backgroundColor ='white';
		                	 container.appendChild(incrementRuleButton);
		                	 
		                 }
						
		                 conditionDecisionTable.appendChild(conditionTableBody);
		                 container.appendChild(conditionDecisionTable);
		                 decisionTableAction.appendChild(actionTableBody);
		                 container.appendChild(decisionTableAction);
		                 tableButton.style.visibility = 'hidden';
				...
				tableButton.setAttribute('title', mxResources.get('table'));
	            tableButton.style.marginTop = '90px';
	            tableButton.style.marginLeft = '130px';

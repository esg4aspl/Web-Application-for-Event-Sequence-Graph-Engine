...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """generateTestCases""", """controllers.ESGController.generateTestCases()"""),
  ...
  // @LINE:24
  private[this] lazy val controllers_ESGController_generateTestCases14_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("generateTestCases")))
  )
  private[this] lazy val controllers_ESGController_generateTestCases14_invoker = createInvoker(
    ESGController_5.generateTestCases(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.ESGController",
      "generateTestCases",
  ...
  // @LINE:44
  private[this] lazy val controllers_BooksController_index15_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books")))
  )
  private[this] lazy val controllers_BooksController_index15_invoker = createInvoker(
  ...
  // @LINE:45
  private[this] lazy val controllers_BooksController_create16_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/create")))
  )
  private[this] lazy val controllers_BooksController_create16_invoker = createInvoker(
  ...
  // @LINE:46
  private[this] lazy val controllers_BooksController_show17_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_BooksController_show17_invoker = createInvoker(
  ...
  // @LINE:47
  private[this] lazy val controllers_BooksController_edit18_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/edit/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_BooksController_edit18_invoker = createInvoker(
  ...
  // @LINE:48
  private[this] lazy val controllers_BooksController_update19_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/edit")))
  )
  private[this] lazy val controllers_BooksController_update19_invoker = createInvoker(
  ...
  // @LINE:49
  private[this] lazy val controllers_BooksController_save20_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/create")))
  )
  private[this] lazy val controllers_BooksController_save20_invoker = createInvoker(
  ...
  // @LINE:50
  private[this] lazy val controllers_BooksController_destroy21_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/delete/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_BooksController_destroy21_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:24
    case controllers_ESGController_generateTestCases14_route(params@_) =>
      call { 
        controllers_ESGController_generateTestCases14_invoker.call(ESGController_5.generateTestCases())
      }
  
    // @LINE:44
    case controllers_BooksController_index15_route(params@_) =>
      call { 
        controllers_BooksController_index15_invoker.call(BooksController_3.index)
      }
  
    // @LINE:45
    case controllers_BooksController_create16_route(params@_) =>
      call { 
        controllers_BooksController_create16_invoker.call(BooksController_3.create())
      }
  
    // @LINE:46
    case controllers_BooksController_show17_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        controllers_BooksController_show17_invoker.call(BooksController_3.show(id))
      }
  
    // @LINE:47
    case controllers_BooksController_edit18_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        controllers_BooksController_edit18_invoker.call(BooksController_3.edit(id))
      }
  
    // @LINE:48
    case controllers_BooksController_update19_route(params@_) =>
      call { 
        controllers_BooksController_update19_invoker.call(BooksController_3.update())
      }
  
    // @LINE:49
    case controllers_BooksController_save20_route(params@_) =>
      call { 
        controllers_BooksController_save20_invoker.call(BooksController_3.save())
      }
  
    // @LINE:50
    case controllers_BooksController_destroy21_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        controllers_BooksController_destroy21_invoker.call(BooksController_3.destroy(id))
      }
  
    // @LINE:53
    case controllers_Assets_versioned22_route(params@_) =>
      call(Param[String]("path", Right("/public")), params.fromPath[Asset]("file", None)) { (path, file) =>
        controllers_Assets_versioned22_invoker.call(Assets_6.versioned(path, file))
      }
  }
}

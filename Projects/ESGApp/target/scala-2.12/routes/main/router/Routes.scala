...
class Routes(
  ...
  // @LINE:25
  private[this] lazy val controllers_BooksController_index11_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books")))
  )
  private[this] lazy val controllers_BooksController_index11_invoker = createInvoker(
  ...
  // @LINE:26
  private[this] lazy val controllers_BooksController_create12_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/create")))
  )
  private[this] lazy val controllers_BooksController_create12_invoker = createInvoker(
  ...
  // @LINE:27
  private[this] lazy val controllers_BooksController_show13_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_BooksController_show13_invoker = createInvoker(
  ...
  // @LINE:28
  private[this] lazy val controllers_BooksController_edit14_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/edit/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_BooksController_edit14_invoker = createInvoker(
  ...
  // @LINE:29
  private[this] lazy val controllers_BooksController_update15_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/edit")))
  )
  private[this] lazy val controllers_BooksController_update15_invoker = createInvoker(
  ...
  // @LINE:30
  private[this] lazy val controllers_BooksController_save16_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/create")))
  )
  private[this] lazy val controllers_BooksController_save16_invoker = createInvoker(
  ...
  // @LINE:31
  private[this] lazy val controllers_BooksController_destroy17_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("books/delete/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_BooksController_destroy17_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:25
    case controllers_BooksController_index11_route(params@_) =>
      call { 
        controllers_BooksController_index11_invoker.call(BooksController_3.index)
      }
  
    // @LINE:26
    case controllers_BooksController_create12_route(params@_) =>
      call { 
        controllers_BooksController_create12_invoker.call(BooksController_3.create())
      }
  
    // @LINE:27
    case controllers_BooksController_show13_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        controllers_BooksController_show13_invoker.call(BooksController_3.show(id))
      }
  
    // @LINE:28
    case controllers_BooksController_edit14_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        controllers_BooksController_edit14_invoker.call(BooksController_3.edit(id))
      }
  
    // @LINE:29
    case controllers_BooksController_update15_route(params@_) =>
      call { 
        controllers_BooksController_update15_invoker.call(BooksController_3.update())
      }
  
    // @LINE:30
    case controllers_BooksController_save16_route(params@_) =>
      call { 
        controllers_BooksController_save16_invoker.call(BooksController_3.save())
      }
  
    // @LINE:31
    case controllers_BooksController_destroy17_route(params@_) =>
      call(params.fromPath[Integer]("id", None)) { (id) =>
        controllers_BooksController_destroy17_invoker.call(BooksController_3.destroy(id))
      }

...
public class routes {
  ...
  public static final controllers.ReverseESGController ESGController = new controllers.ReverseESGController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseESGController ESGController = new controllers.javascript.ReverseESGController(RoutesPrefix.byNamePrefix());
  }
